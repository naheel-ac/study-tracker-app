...
class AuthBloc extends Bloc<AuthEvent, AuthState>{
  ...
  AuthBloc({required this.getCurrentUserUseCase, required this.signInUseCase, required this.signUpUseCase, required this.signOutUseCase}):super(AuthInitial()){
  ...
  Future<void>_onAuthCheckRequest(AuthCheckRequest event, Emitter<AuthState>emit)async{
    emit(AuthLoading());
    try{
